# Security: REST Quickstart (.NET)

`call_rest_api.cs` makes one authenticated HTTPS request to the REST API and prints a
...
| **Tampering** | Request changed in transit | HTTPS/TLS in runtime transport | Mitigated |
